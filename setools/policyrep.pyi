...
class DefaultRangeValue(PolicyEnum):
    ...
    low_high: int = ...
    @classmethod
    def from_default_range(self, range: int | None) -> "DefaultRangeValue" | None: ...
...
class IbpkeyconRange(NamedTuple):
    high: int = ...
    low: int = ...
...
class IomemconRange(NamedTuple):
    high: int = ...
    low: int = ...
...
class IoportconRange(NamedTuple):
    high: int = ...
    low: int = ...
