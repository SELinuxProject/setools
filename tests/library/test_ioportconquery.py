...
from setools import IoportconQuery, IoportconRange
...
class IoportconQueryTest(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.p = compile_policy("tests/library/ioportconquery.conf", xen=True)
    ...
    def test_010_user_exact(self):
        ...
        self.assertListEqual([IoportconRange(10, 10)], ports)
    ...
    def test_011_user_regex(self):
        ...
        ports = sorted(p.ports for p in q.results())
        self.assertListEqual([IoportconRange(11, 11), IoportconRange(11000, 11000)], ports)
    ...
    def test_020_role_exact(self):
        ...
        ports = sorted(p.ports for p in q.results())
        self.assertListEqual([IoportconRange(20, 20)], ports)
    ...
    def test_021_role_regex(self):
        ...
        ports = sorted(p.ports for p in q.results())
        self.assertListEqual([IoportconRange(21, 21), IoportconRange(21001, 21001)], ports)
    ...
    def test_030_type_exact(self):
        ...
        ports = sorted(p.ports for p in q.results())
        self.assertListEqual([IoportconRange(30, 30)], ports)
    ...
    def test_031_type_regex(self):
        ...
        ports = sorted(p.ports for p in q.results())
        self.assertListEqual([IoportconRange(31000, 31000), IoportconRange(31001, 31001)], ports)
    ...
    def test_040_range_exact(self):
        ...
        ports = sorted(p.ports for p in q.results())
        self.assertListEqual([IoportconRange(40, 40)], ports)
    ...
    def test_041_range_overlap1(self):
        ...
        ports = sorted(p.ports for p in q.results())
        self.assertListEqual([IoportconRange(41, 41)], ports)
    ...
    def test_042_range_subset1(self):
        ...
        ports = sorted(p.ports for p in q.results())
        self.assertListEqual([IoportconRange(42, 42)], ports)
    ...
    def test_043_range_superset1(self):
        ...
        ports = sorted(p.ports for p in q.results())
        self.assertListEqual([IoportconRange(43, 43)], ports)
    ...
    def test_044_range_proper_subset1(self):
        ...
        ports = sorted(p.ports for p in q.results())
        self.assertListEqual([IoportconRange(44, 44)], ports)
    ...
    def test_045_range_proper_superset1(self):
        ...
        ports = sorted(p.ports for p in q.results())
        self.assertListEqual([IoportconRange(45, 45)], ports)
    ...
    def test_050_single_equal(self):
        ...
        ports = sorted(p.ports for p in q.results())
        self.assertListEqual([IoportconRange(50, 50)], ports)
    ...
    def test_051_range_equal(self):
        ...
        ports = sorted(p.ports for p in q.results())
        self.assertListEqual([IoportconRange(50100, 50110)], ports)
    ...
    def test_052_single_subset(self):
        ...
        ports = sorted(p.ports for p in q.results())
        self.assertListEqual([IoportconRange(50200, 50200)], ports)
    ...
    def test_053_range_subset(self):
        ...
        ports = sorted(p.ports for p in q.results())
        self.assertListEqual([IoportconRange(50300, 50310)], ports)
    ...
    def test_055_range_proper_subset(self):
        ...
        ports = sorted(p.ports for p in q.results())
        self.assertListEqual([IoportconRange(50500, 50510)], ports)
    ...
    def test_056_single_superset(self):
        ...
        ports = sorted(p.ports for p in q.results())
        self.assertListEqual([IoportconRange(50601, 50601)], ports)
    ...
    def test_057_range_superset(self):
        ...
        ports = sorted(p.ports for p in q.results())
        self.assertListEqual([IoportconRange(50700, 50710)], ports)
    ...
    def test_058_single_proper_superset(self):
        ...
        ports = sorted(p.ports for p in q.results())
        self.assertListEqual([IoportconRange(50801, 50801)], ports)
    ...
    def test_059_range_proper_superset(self):
        ...
        ports = sorted(p.ports for p in q.results())
        self.assertListEqual([IoportconRange(50901, 50910)], ports)
    ...
    def test_060_single_overlap(self):
        ...
        ports = sorted(p.ports for p in q.results())
        self.assertListEqual([IoportconRange(60001, 60001)], ports)
    ...
    def test_061_range_overlap_low_half(self):
        ...
        ports = sorted(p.ports for p in q.results())
        self.assertListEqual([IoportconRange(60101, 60110)], ports)
    ...
    def test_062_range_overlap_high_half(self):
        ...
        ports = sorted(p.ports for p in q.results())
        self.assertListEqual([IoportconRange(60200, 60210)], ports)
    ...
    def test_063_range_overlap_middle(self):
        ...
        ports = sorted(p.ports for p in q.results())
        self.assertListEqual([IoportconRange(60300, 60310)], ports)
    ...
    def test_064_range_overlap_equal(self):
        ...
        ports = sorted(p.ports for p in q.results())
        self.assertListEqual([IoportconRange(60400, 60410)], ports)
    ...
    def test_065_range_overlap_superset(self):
        ...
        ports = sorted(p.ports for p in q.results())
        self.assertListEqual([IoportconRange(60501, 60509)], ports)
