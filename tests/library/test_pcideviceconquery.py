...
@pytest.mark.obj_args("tests/library/pcideviceconquery.conf", xen=True)
class TestPcideviceconQuery:
    ...
    def test_unset(self, compiled_policy: setools.SELinuxPolicy) -> None:
        ...
        rules = sorted(compiled_policy.pcidevicecons())
    ...
    def test_user_exact(self, compiled_policy: setools.SELinuxPolicy) -> None:
        ...
        q = setools.PcideviceconQuery(compiled_policy, user="user10", user_regex=False)
    ...
    def test_user_regex(self, compiled_policy: setools.SELinuxPolicy) -> None:
        ...
        q = setools.PcideviceconQuery(compiled_policy, user="user11(a|b)", user_regex=True)

        device = sorted(p.device for p in q.results())
        assert [(11), (11000)] == device

    def test_role_exact(self, compiled_policy: setools.SELinuxPolicy) -> None:
        """Pcidevicecon query with context role exact match"""
        q = setools.PcideviceconQuery(compiled_policy, role="role20_r", role_regex=False)
    ...
    def test_role_regex(self, compiled_policy: setools.SELinuxPolicy) -> None:
        ...
        q = setools.PcideviceconQuery(compiled_policy, role="role21(a|c)_r", role_regex=True)

        device = sorted(p.device for p in q.results())
        assert [(21), (21001)] == device

    def test_type_exact(self, compiled_policy: setools.SELinuxPolicy) -> None:
        """Pcidevicecon query with context type exact match"""
        q = setools.PcideviceconQuery(compiled_policy, type_="type30", type_regex=False)
    ...
    def test_type_regex(self, compiled_policy: setools.SELinuxPolicy) -> None:
        ...
        q = setools.PcideviceconQuery(compiled_policy, type_="type31(b|c)", type_regex=True)

        device = sorted(p.device for p in q.results())
        assert [(31000), (31001)] == device

    def test_range_exact(self, compiled_policy: setools.SELinuxPolicy) -> None:
        """Pcidevicecon query with context range exact match"""
        q = setools.PcideviceconQuery(compiled_policy, range_="s0:c1 - s0:c0.c4")
    ...
    def test_range_overlap1(self, compiled_policy: setools.SELinuxPolicy) -> None:
        ...
        q = setools.PcideviceconQuery(compiled_policy, range_="s1:c1 - s1:c0.c4",
                                      range_overlap=True)
    ...
    def test_range_overlap2(self, compiled_policy: setools.SELinuxPolicy) -> None:
        ...
        q = setools.PcideviceconQuery(compiled_policy, range_="s1:c1,c2 - s1:c0.c3",
                                      range_overlap=True)
    ...
    def test_range_overlap3(self, compiled_policy: setools.SELinuxPolicy) -> None:
        ...
        q = setools.PcideviceconQuery(compiled_policy, range_="s1 - s1:c0.c4", range_overlap=True)
    ...
    def test_range_overlap4(self, compiled_policy: setools.SELinuxPolicy) -> None:
        ...
        q = setools.PcideviceconQuery(compiled_policy, range_="s1 - s1:c1,c2", range_overlap=True)
    ...
    def test_range_overlap5(self, compiled_policy: setools.SELinuxPolicy) -> None:
        ...
        q = setools.PcideviceconQuery(compiled_policy, range_="s1:c1,c2 - s1:c0.c4",
                                      range_overlap=True)
    ...
    def test_range_subset1(self, compiled_policy: setools.SELinuxPolicy) -> None:
        ...
        q = setools.PcideviceconQuery(compiled_policy, range_="s2:c1,c2 - s2:c0.c3",
                                      range_overlap=True)
    ...
    def test_range_subset2(self, compiled_policy: setools.SELinuxPolicy) -> None:
        ...
        q = setools.PcideviceconQuery(compiled_policy, range_="s2:c1 - s2:c1.c3",
                                      range_overlap=True)
    ...
    def test_range_superset1(self, compiled_policy: setools.SELinuxPolicy) -> None:
        ...
        q = setools.PcideviceconQuery(compiled_policy, range_="s3 - s3:c0.c4", range_superset=True)
    ...
    def test_range_superset2(self, compiled_policy: setools.SELinuxPolicy) -> None:
        ...
        q = setools.PcideviceconQuery(compiled_policy, range_="s3:c1 - s3:c1.c3",
                                      range_superset=True)
    ...
    def test_range_proper_subset1(self, compiled_policy: setools.SELinuxPolicy) -> None:
        ...
        q = setools.PcideviceconQuery(compiled_policy, range_="s4:c1,c2", range_subset=True,
                                      range_proper=True)
    ...
    def test_range_proper_subset2(self, compiled_policy: setools.SELinuxPolicy) -> None:
        ...
        q = setools.PcideviceconQuery(compiled_policy, range_="s4:c1 - s4:c1.c3",
    ...
    def test_range_proper_subset3(self, compiled_policy: setools.SELinuxPolicy) -> None:
        ...
        q = setools.PcideviceconQuery(compiled_policy, range_="s4:c1 - s4:c1.c2",
                                      range_subset=True, range_proper=True)
    ...
    def test_range_proper_subset4(self, compiled_policy: setools.SELinuxPolicy) -> None:
        ...
        q = setools.PcideviceconQuery(compiled_policy, range_="s4:c1,c2 - s4:c1.c3",
                                      range_subset=True, range_proper=True)
    ...
    def test_range_proper_superset1(self, compiled_policy: setools.SELinuxPolicy) -> None:
        ...
        q = setools.PcideviceconQuery(compiled_policy, range_="s5 - s5:c0.c4", range_superset=True,
                                      range_proper=True)
    ...
    def test_range_proper_superset2(self, compiled_policy: setools.SELinuxPolicy) -> None:
        ...
        q = setools.PcideviceconQuery(compiled_policy, range_="s5:c1 - s5:c1.c3",
    ...
    def test_range_proper_superset3(self, compiled_policy: setools.SELinuxPolicy) -> None:
        ...
        q = setools.PcideviceconQuery(compiled_policy, range_="s5:c1 - s5:c1.c4",
                                      range_superset=True, range_proper=True)
    ...
    def test_range_proper_superset4(self, compiled_policy: setools.SELinuxPolicy) -> None:
        ...
        q = setools.PcideviceconQuery(compiled_policy, range_="s5 - s5:c1.c3", range_superset=True,
                                      range_proper=True)
