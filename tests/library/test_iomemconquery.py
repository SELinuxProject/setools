...
from setools import IomemconQuery, IomemconRange
...
class IomemconQueryTest(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.p = compile_policy("tests/library/iomemconquery.conf", xen=True)
    ...
    def test_010_user_exact(self):
        ...
        self.assertListEqual([IomemconRange(10, 10)], addr)
    ...
    def test_011_user_regex(self):
        ...
        addr = sorted(p.addr for p in q.results())
        self.assertListEqual([IomemconRange(11, 11), IomemconRange(11000, 11000)], addr)
    ...
    def test_020_role_exact(self):
        ...
        addr = sorted(p.addr for p in q.results())
        self.assertListEqual([IomemconRange(20, 20)], addr)
    ...
    def test_021_role_regex(self):
        ...
        addr = sorted(p.addr for p in q.results())
        self.assertListEqual([IomemconRange(21, 21), IomemconRange(21001, 21001)], addr)
    ...
    def test_030_type_exact(self):
        ...
        addr = sorted(p.addr for p in q.results())
        self.assertListEqual([IomemconRange(30, 30)], addr)
    ...
    def test_031_type_regex(self):
        ...
        addr = sorted(p.addr for p in q.results())
        self.assertListEqual([IomemconRange(31000, 31000), IomemconRange(31001, 31001)], addr)
    ...
    def test_040_range_exact(self):
        ...
        addr = sorted(p.addr for p in q.results())
        self.assertListEqual([IomemconRange(40, 40)], addr)
    ...
    def test_041_range_overlap1(self):
        ...
        addr = sorted(p.addr for p in q.results())
        self.assertListEqual([IomemconRange(41, 41)], addr)
    ...
    def test_042_range_subset1(self):
        ...
        addr = sorted(p.addr for p in q.results())
        self.assertListEqual([IomemconRange(42, 42)], addr)
    ...
    def test_043_range_superset1(self):
        ...
        addr = sorted(p.addr for p in q.results())
        self.assertListEqual([IomemconRange(43, 43)], addr)
    ...
    def test_044_range_proper_subset1(self):
        ...
        addr = sorted(p.addr for p in q.results())
        self.assertListEqual([IomemconRange(44, 44)], addr)
    ...
    def test_045_range_proper_superset1(self):
        ...
        addr = sorted(p.addr for p in q.results())
        self.assertListEqual([IomemconRange(45, 45)], addr)
    ...
    def test_050_single_equal(self):
        ...
        addr = sorted(p.addr for p in q.results())
        self.assertListEqual([IomemconRange(50, 50)], addr)
    ...
    def test_051_range_equal(self):
        ...
        addr = sorted(p.addr for p in q.results())
        self.assertListEqual([IomemconRange(50100, 50110)], addr)
    ...
    def test_052_single_subset(self):
        ...
        addr = sorted(p.addr for p in q.results())
        self.assertListEqual([IomemconRange(50200, 50200)], addr)
    ...
    def test_053_range_subset(self):
        ...
        addr = sorted(p.addr for p in q.results())
        self.assertListEqual([IomemconRange(50300, 50310)], addr)
    ...
    def test_055_range_proper_subset(self):
        ...
        addr = sorted(p.addr for p in q.results())
        self.assertListEqual([IomemconRange(50500, 50510)], addr)
    ...
    def test_056_single_superset(self):
        ...
        addr = sorted(p.addr for p in q.results())
        self.assertListEqual([IomemconRange(50601, 50601)], addr)
    ...
    def test_057_range_superset(self):
        ...
        addr = sorted(p.addr for p in q.results())
        self.assertListEqual([IomemconRange(50700, 50710)], addr)
    ...
    def test_058_single_proper_superset(self):
        ...
        addr = sorted(p.addr for p in q.results())
        self.assertListEqual([IomemconRange(50801, 50801)], addr)
    ...
    def test_059_range_proper_superset(self):
        ...
        addr = sorted(p.addr for p in q.results())
        self.assertListEqual([IomemconRange(50901, 50910)], addr)
    ...
    def test_060_single_overlap(self):
        ...
        addr = sorted(p.addr for p in q.results())
        self.assertListEqual([IomemconRange(60001, 60001)], addr)
    ...
    def test_061_range_overlap_low_half(self):
        ...
        addr = sorted(p.addr for p in q.results())
        self.assertListEqual([IomemconRange(60101, 60110)], addr)
    ...
    def test_062_range_overlap_high_half(self):
        ...
        addr = sorted(p.addr for p in q.results())
        self.assertListEqual([IomemconRange(60200, 60210)], addr)
    ...
    def test_063_range_overlap_middle(self):
        ...
        addr = sorted(p.addr for p in q.results())
        self.assertListEqual([IomemconRange(60300, 60310)], addr)
    ...
    def test_064_range_overlap_equal(self):
        ...
        addr = sorted(p.addr for p in q.results())
        self.assertListEqual([IomemconRange(60400, 60410)], addr)
    ...
    def test_065_range_overlap_superset(self):
        ...
        addr = sorted(p.addr for p in q.results())
        self.assertListEqual([IomemconRange(60501, 60509)], addr)
