...
class FSUseRuletype(CheckboxSetWidget):
    ...
    list consisting of object names (fs_use_* ruletypes) and stored in the query's
    specified attribute.
    """
    ...
    def __init__(self, title: str, query: setools.PolicyQuery, attrname: str = "ruletype",
        ...
        super().__init__(title, query, attrname, (rt.name for rt in setools.FSUseRuletype),
...
if __name__ == '__main__':
    ...
    q = setools.FSUseQuery(setools.SELinuxPolicy())
