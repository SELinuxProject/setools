...
@pytest.fixture
def widget(mock_policy, request: pytest.FixtureRequest, qtbot: QtBot) -> PortconQueryTab:
...
def test_docs(widget: PortconQueryTab) -> None:
...
def test_layout(widget: PortconQueryTab) -> None:
...
def test_criteria_mapping(widget: PortconQueryTab) -> None:
